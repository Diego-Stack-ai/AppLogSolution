...
def main():
    if len(sys.argv) < 2:
        print("Uso: py crea_punti_consegna.py <data>   (es. 16-03-2026)")
        return 1
    ...
    input_frutta = output_base / "DDT-ORIGINALI-DIVISI" / "FRUTTA"
    input_latte = output_base / "DDT-ORIGINALI-DIVISI" / "LATTE"
