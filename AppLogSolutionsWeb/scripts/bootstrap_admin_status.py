...
def main():
    ...
    if project_id not in ['log-solutions-cantiere', 'log-solution-60007']:
        print(f"ERRORE CRITICO: Il project_id rilevato e' '{project_id}'. Questo script PUO' ESSERE ESEGUITO SOLO SU 'log-solutions-cantiere'.")
        sys.exit(1)
